...
const app = new (0, _controller.Controller)(new (0, _model.Model)(), new (0, _view.View)());

},{"./view":"ky8MP","./model":"Y4A21","./controller":"aenu9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ky8MP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    onEditListner() {
        this.toDoList.addEventListener("input", (event)=>{
            if (event.target.classList.contains('editable')) this.currentEditingText = event.target.innerText;
        });
    }
    resetInput() {
        this.input.value = "";
        ...
        this.toDoList.addEventListener("click", (event)=>{
            if (event.target.classList.contains("edit")) {
                ...
                saveButton.addEventListener("click", ()=>{
                    ...
                    if (newText && newText !== taskText.textContent) handler(toDoItem.id, newText, toDoItem.querySelector(".list-item_checkbox").checked);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aenu9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
